...
import { c as cordova, I as IonicNativePlugin, n as nav, A as flxPush, C as ConftokenProvider, W as Webapi, w as storage, u as util, l as flxSync } from './conftoken-949aae77.js';
...
const AppRoot = class {
  ...
  async navToFirstMenu(page, api) {
    ...
    const was_logged_out = await storage.get('loggedOut');
    if (!auth || (!auth.b64 && !auth.sso_token) || !app || was_logged_out) {
      nav.goLogin();
      return;
    }
