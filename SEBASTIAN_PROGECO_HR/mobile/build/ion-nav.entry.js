import { r as registerInstance, o as createEvent, h as Build, k as h, l as getElement } from './index-3f6ae35e.js';
import { g as getIonMode, c as config } from './ionic-global-7b33f09f.js';
import { g as getTimeGivenProgression } from './cubic-bezier-ed243a9b.js';
import { l as assert } from './helpers-0fb1c204.js';
import { l as lifecycle, L as LIFECYCLE_WILL_UNLOAD, a as LIFECYCLE_WILL_LEAVE, b as LIFECYCLE_DID_LEAVE, t as transition, s as setPageHidden } from './index-7e5eab7f.js';
import { a as attachComponent } from './framework-delegate-1f321987.js';
...
const Nav = class {
  ...
  async componentDidLoad() {
    this.rootChanged();
    this.gesture = (await import('./swipe-back-a175cec4.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
