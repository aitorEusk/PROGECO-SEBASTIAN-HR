        ...
        <div id="license">
            ...
            <div class="divPanel">
                ...
                <asp:PlaceHolder runat="server" ID="pnlUnlicensed" Visible="false" >
                    ...
                    <div class="cell">
                        ...
                        <asp:Label runat="server" ID="lblOfflineUnlicensedMsg">
                            <p>Please register at <a href="<%=CURL_ABHLICENSESERVER%>" class="link" target="_blank"><%=CURL_ABHLICENSESERVER%></a> and paste the request data to obtain the license</p>
                        </asp:Label>
                 ...
                 <asp:PlaceHolder runat="server" ID="pnlRequested" Visible="false" >
                     ...
                     <asp:PlaceHolder runat="server" ID="pnlRequestedOnline">
                         ...
                         <p>Request new license at <a href="<%=CURL_ABHLICENSESERVER%>" class="link" target="_blank"><%=CURL_ABHLICENSESERVER%></a> click on button to update your license data</p>
                     ...
                     <asp:PlaceHolder runat="server" ID="pnlRequestedOffline">
                         ...
                         <div class="cell">
                             ...
                             <p>Request new license at <a href="<%=CURL_ABHLICENSESERVER%>" class="link" target="_blank"><%=CURL_ABHLICENSESERVER%></a> and paste here your license data to update your license information</p>
                ...
                <asp:PlaceHolder runat="server" ID="notActivatedPanel" Visible="false" >
                    ...
                    <div class="cell">
                         ...
                         <asp:PlaceHolder runat="server" ID="notRequestedPanel" Visible="false" >
                            ...
                            <p>To activate your license, you must be registered at <a href="<%=CURL_ABHLICENSESERVER%>" class="link" target="_blank"><%=CURL_ABHLICENSESERVER%></a></p>
                        ...
                        <asp:PlaceHolder runat="server" ID="requestedPanel" Visible="false" >
                            <h4>Get the activation code on the ABH portal: <a href="<%=CURL_ABHLICENSESERVER%>" class="link" target="_blank"><%=CURL_ABHLICENSESERVER%></a> </h4>
                             <table class="row">
                         ...
                         <asp:CheckBox ID="chkActivationCode" runat="server" AutoPostBack="true" Checked="true" style="display:none;" Text="I have an activation code"></asp:CheckBox>
                ...
                <asp:PlaceHolder runat="server" ID="activatedPanel" Visible="false" >
                    ...
                    <asp:PlaceHolder runat="server" ID ="validPanel">
                        ...
                        <div class="cell">
                         ...
                         <table class="row">
                            ...
                            <tr>
                               <td class="col-4">
                                    <asp:Label ID="lblModules" runat="server" Visible="false" Text="Modules:"></asp:Label>
                                </td>
                                <td class="col-8">
                                    <asp:TextBox ID="txtModules" runat="server" Visible="false" AutoPostBack="true"></asp:TextBox>
                                </td>
                            </tr>
                 ...
                 <asp:LinkButton   ID="btnModify"  runat="server" Visible="false" Enabled="false">Modify license</asp:LinkButton>
