                            ...
                            if (this.options.AllowNewFunction) {
                                ...
                                flexygo.events.on(this, "entity", "inserted", (e) => {
                                    if (this.options.AllowNewObject === e.masterIdentity) {
                                        ...
                                        this.loadValues(0);
                                        this.addValue(value, this.getTextByValue(value));
                                        this.triggerDependencies();
