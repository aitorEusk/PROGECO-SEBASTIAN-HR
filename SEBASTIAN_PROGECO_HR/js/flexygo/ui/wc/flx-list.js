               ...
               */
                ...
                */
                ...
                setColResizable(tbl) {
                    ...
                    tbl.colResizable({
                        resizeMode: 'overflow', disabledColumns: [0], postbackSafe: true, liveDrag: 1, onResize: (ev) => {
               ...
               */
                ...
                */
                paintHeader(row) {
                    ...
                    thead.html(tr);
                    return '<table id="tbl-' + ident + '" class="flxRszTbl" ><thead>' + thead.html() + '</thead><tbody>';
                }
                /**
              * Paint footer
              * @method paintFooter
            ...
            function clearRow(list, btn) {
                ...
                cells.each((i, e) => {
                    ...
                    if (ctl) {
                        ...
                        ctl.page = 0; //So if a combo has scrolled all way through it does work good
                        ctl.init();
