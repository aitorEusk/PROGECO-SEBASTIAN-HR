            ...
            */
            class FlxPropertyManagerElement extends HTMLElement {
                ...
                setProperties(response, objectname, objectwhere) {
                    ...
                    this.offline = response.Offline === true;
                ...
                render() {
                    ...
                    if (this.mode == 'list') {
                        ...
                        me.empty();
                        me.html(rendered);
                        me.find('table').colResizable({ disable: true });
                ...
                addConfigToolbar() {
                    ...
                    <p>-${flexygo.localization.translate('flxedit.altLabel')}</p>
                </div>`;
                ...
                addProperties(checks) {
                    ...
                    flexygo.utils.showLoading(this.parentElement, flexygo.localization.translate('flxpropertymanager.addingProperties'), null, 10);
                    flexygo.ajax.promisePost('~/api/Edit', 'AddNewProperties', params, false)
                        .then(() => {
                        this.refresh();
                    }).finally(() => {
                        flexygo.utils.removeLoadingEffect(this.parentElement);
                    });
                }
                filterProperties(e) {
                    let me = $(this);
                ...
                paintHeader() {
                    ...
                    thead.html(tr);
                    return '<table id="editlist-' + this.objectname + '"><thead>' + thead.html() + '</thead><tbody>';
                }
                paintFooter() {
                    let tfoot = $('<tfoot />');
