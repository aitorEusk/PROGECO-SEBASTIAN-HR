    ...
    (function (culture) {
        ...
        (function (caes) {
            ...
            caes.navigation = {
                ...
                reportinfo: 'Generant informe... Si us plau, espereu.'
            };
            caes.flxfilter = {
            ...
            caes.flxedit = {
                ...
                altLabel: "En fer focus al label d'una propietat podràs veure'n el nom en pressionar la tecla alt"
            };
            caes.flxeditgrid = {
                addrow: 'Afegeix fila',
            ...
            caes.objectmanager = {
                ...
                manuallygeneration: 'Generació Manual',
                aigeneration: ' Generació d’IA',
                generatingobjects: 'Generant Objectes',
                generatingtemplate: 'Generant Plantilles',
                objectsaved: 'Objecte desat :)',
            ...
            caes.flxpropertymanager = {
                ...
                sqlObjectName: "Objecte font de dades",
                sqlViewName: "Vista de la font de dades",
                sqlOfflineSentence: "Sentencia SQL Offline",
                addingProperties: "Afegint propietats...",
                decimalPlaces: "Número de decimals"
            };
            caes.flxversioninfo = {
            ...
            caes.flxBarcode = {
                scanCode: "Escanejar Codi",
                uploadImage: "Pujar Imatge",
                switchCamera: "Alternar càmera"
            };
            caes.abhSign = {
                save: 'Guardar',
            ...
            caes.flxai = {
                beginMessage: 'Hola!\nCom puc ajudar-te?',
                alertInfoMessage: 'No has configurat el Bearer Token, si us plau, revisa la documentació.',
                settingNotFound: 'No s\'ha pogut obtenir la configuració de l\'assistent amb SettindId "{0}".',
                placeholder: "Pregunti lo que necesitis...",
                mediatypenotallowed: "Tipus de mitjà no permès",
                filepreview: "Previsualització del fitxer",
                removedocument: "Eliminar document",
                senddocument: "Enviar documents a l'assistent",
                aititle: "IA",
                aitooltip: "Assistent basat en el model d'OpenAI ",
                aierror: "Error en representar la informació. Torneu-ho a provar. Si el problema persisteix, considereu canviar a un model millor.",
            };
            caes.excelExport = {
            ...
            caes.dbviewer = {
                whichtables: 'Quines taules?',
                summary: 'Resum',
                withTestData: 'Amb Dades De Prova',
                withoutTestData: 'Sense Dades De Prova',
                generateObjects: 'Generar Objectes',
                retry: 'Reintentar',
                executeScript: 'Executar Script',
            };
            caes.flxaddonmarket = {
                download: 'Descarrega',
                search: 'Cercar addons...',
                notfound: 'No s\'han trobat addons',
                uninstall: 'Vols desinstal·lar aquest addon?',
                install: 'Vols instal·lar aquest addon?',
                installing: 'S\'està instal·lant l\'addon...',
                update: 'Actualitza',
                complete: 'Instal·lat',
                delete: 'Eliminar'
            };
