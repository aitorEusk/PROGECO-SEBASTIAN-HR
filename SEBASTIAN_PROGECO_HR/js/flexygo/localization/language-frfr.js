    ...
    (function (culture) {
        ...
        (function (frfr) {
            ...
            frfr.navigation = {
                ...
                scrolltop: 'Monter',
                reportinfo: 'Génération du rapport... Veuillez patienter.'
            };
            frfr.msg = {
            ...
            frfr.flxedit = {
                ...
                altLabel: "Lorsque vous vous concentrez sur l'étiquette d'une propriété, vous pouvez voir son nom en appuyant sur la touche alt"
            };
            frfr.flxeditgrid = {
            ...
            frfr.objectmanager = {
                ...
                manuallygeneration: 'Génération Manuelle',
                aigeneration: 'Génération d’IA',
                generatingobjects: 'Générant des Objets',
                generatingtemplate: 'Générant des Modèles',
                objectsaved: 'Objet enregistré :)',
            ...
            frfr.flxpropertymanager = {
                ...
                sqlObjectName: "Objet de source de données",
                sqlViewName: "Affichage de la source de données",
            ...
            frfr.flxai = {
                ...
                alertInfoMessage: 'Vous n\'avez pas configuré le jeton Bearer, veuillez vérifier la documentation.',
                ...
                mediatypenotallowed: "Type de média non autorisé",
                filepreview: "Aperçu du fichier",
                removedocument: "Supprimer le document",
                senddocument: "Envoyer des documents à l'assistant",
                aititle: "IA",
                aitooltip: "Assistant propulsé par le modèle OpenAI ",
                aierror: "Erreur lors de la représentation des informations. Réessayez. Si le problème persiste, envisagez de passer à un meilleur modèle.",
            };
            frfr.excelExport = {
            ...
            frfr.dbviewer = {
                whichtables: 'Quelles tables ?',
                summary: 'Résumé',
                withTestData: 'Avec Des Données De Test',
                withoutTestData: 'Sans Données De Test',
                generateObjects: 'Générer Des Objets',
                retry: 'Réessayer',
                executeScript: 'Exécuter le Script',
            };
            frfr.flxaddonmarket = {
                download: 'Télécharger',
                search: 'Rechercher des addons...',
                notfound: 'Aucun addon trouvé',
                uninstall: 'Voulez-vous désinstaller cet addon ?',
                install: 'Voulez-vous installer cet addon ?',
