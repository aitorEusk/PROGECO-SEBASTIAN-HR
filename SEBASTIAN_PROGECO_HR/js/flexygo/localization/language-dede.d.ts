 ...
 */
declare namespace flexygo.culture.dede {
    const process: {
        executing: string;
        loadingdata: string;
    ...
    const flxgipe: {
        ...
        editorobject: string;
        editordecission: string;
        editorevent: string;
        editorworkflow: string;
        editorlabel: string;
        editortoggleall: string;
        editortoolbar: {
            new: string;
            open: string;
            save: string;
    ...
    const objectmanager: {
        ...
        manuallygeneration: string;
        aigeneration: string;
        generatingobjects: string;
    ...
    const dbviewer: {
        ...
        summary: string;
        withTestData: string;
        withoutTestData: string;
        generateObjects: string;
        retry: string;
        executeScript: string;
    };
    const flxaddonmarket: {
        download: string;
        search: string;
        notfound: string;
        uninstall: string;
