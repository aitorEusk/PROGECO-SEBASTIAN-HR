                            ...
                            if ((json && typeof json[jKey] != 'undefined') || (contextVars && typeof contextVars[jKey] != 'undefined') || (contextFunctions && typeof contextFunctions[jKeyUp] != 'undefined') || (jKey == 'currentdatetime') || (jKey == 'currentdate')) {
                                ...
                                if (typeF == 'date') { /*{{datevalue|date:LLL}*/
                                    ...
                                    if (rValue && rValue != '') {
                                        ...
                                        else if (strFormat.toLowerCase() == 'capitalized') {
                                            rValue = rValue.toLowerCase().replace(/\b\w/g, char => char.toUpperCase());
                                        }
                    ...
                    if (tmp.Body && tmp.Body != '') {
                        ...
                        if (dataTbl.length > 0) {
                            ...
                            for (let i = 0; i < dataTbl.length; i++) {
                                dataTbl[i]._objectdefaults = (_a = tmp.defaults) === null || _a === void 0 ? void 0 : _a._objectdefaults;
