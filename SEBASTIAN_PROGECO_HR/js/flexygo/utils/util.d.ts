...
declare namespace flexygo.utils {
    ...
    */
    function copyClipboard(text: string): Promise<boolean>;
    /**
    ...
    */
     ...
     */
    function getOS(): "WINDOWS" | "MACOS" | "ANDROID" | "IOS" | "LINUX";
    /**
   ...
   */
    ...
    */
    ...
    function randomColorClass(seed: any): string;
...
*/
    ...
    const showLoading: (element?: any, text?: any, position?: any, zIndex?: any) => void;
    const showLoadingEffect: (time?: number, element?: any, text?: string, position?: any, noTimer?: boolean, zIndex?: any) => void;
...
declare namespace flexygo.utils.geTablesChangeTemplate {
    ...
    function executeLoadedModuleFunctions(module: any): void;
...
declare namespace flexygo.utils.modules {
    ...
    function createLabelProperty(poperty_name: string, label: string): {
        _SQlSentence: string;
        _SQLEditSentence: string;
        DropDownRows: number;
        CanView: boolean;
        CanEdit: boolean;
        ...
        SQLViewName: string;
        SQLOfflineSentence: string;
        SQLOfflineOrderBy: string;
        ...
        ComboAllowSave_Object: any;
        ComboAllowSave_DisplayField: any;
        ComboAllowSave_ValueField: any;
        ComboAllowSave_Defaults: any;
        ComboAllowSave_WarningMessage: boolean;
        ComboAllowSave_CanInsert: boolean;
        CustomPropName: any;
        IsCustomControl: boolean;
        DescriptionInApi: any;
        ShowValuesInApi: boolean;
    };
}
