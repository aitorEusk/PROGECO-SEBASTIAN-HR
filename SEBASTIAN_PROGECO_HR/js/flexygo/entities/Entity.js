        ...
        */
        class Entity {
           ...
           */
            ...
            */
            getView(viewName, page, pageSize, filter, orderBy, cllback, withDescrips, defaults) {
                let defaults_param;
                if (defaults) {
                    if (typeof defaults == 'string') {
                        defaults_param = JSON.parse(flexygo.utils.parser.replaceAll(defaults, "'", '"'));
                    }
                    else {
                ...
                var ctx = this;
                var params = { ObjectName: null, ObjectWhere: null, ViewName: null, Page: null, PageSize: null, Filter: null, OrderBy: null, WithDescrips: false, Defaults: null };
                params.ObjectName = ctx.objectName;
                ...
                params.Defaults = defaults_param || null;
                if (cllback) {
