<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ClaveAuth.aspx.vb" Inherits="FLEXYGO.ClaveAuth" %>
...
<body>
    <form id="claveAuthForm" runat="server" DefaultButton="MainButton">
