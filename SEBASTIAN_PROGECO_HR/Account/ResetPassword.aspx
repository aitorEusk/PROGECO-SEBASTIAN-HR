            ...
            <div class="divlogin">
                ...
                <section id="loginForm">
                    ...
                    <div class="cell"><i class="flx-icon icon-password"></i>
                        ...
                        <span class="fa fa-eye" id="pass-status" onclick="viewPassword('Password','pass-status')"></span> 
                    </div>
                    ...
                    <div class="cell"><i class="flx-icon icon-password"></i>
                        ...
                        <span class="fa fa-eye" id="ConfirmPass-status" onclick="viewPassword('ConfirmPassword','ConfirmPass-status')"></span> 
