...
[{
	"ModuleName":"PERS_DEPURACION",
	"TypeId":"flx-html",
	"ClassId":"project",
	"Descrip":"PERS_DEPURACION",
	"Title":"PERS_DEPURACION",
	"ContainerId":"default",
	"CollapsibleButton":true,
	"FullscreenButton":true,
	"RefreshButton":true,
	"SearchButton":false,
	"HTMLText":"<flx-navbutton class=\"test\" type=\"execprocess\" processname=\"SincronizarMarcajesTipos\" targetid=\"popup\" excludehist=\"false\" showprogress=\"true\">\n',
N'      <button class=\"btn btn-outstanding\">SincronizarMarcajesTipos<\/button>\n',
N'<\/flx-navbutton>\n',
N'\n',
N'<flx-navbutton class=\"test\" type=\"execprocess\" processname=\"SincronizarEmpleadosNetTime\" targetid=\"popup\" excludehist=\"false\" showprogress=\"true\">\n',
N'      <button class=\"btn btn-outstanding\">SincronizarEmpleadosNetTime<\/button>\n',
N'<\/flx-navbutton>\n',
N'\n',
N'<flx-navbutton class=\"test\" type=\"execprocess\" processname=\"SincronizarMarcajes\" targetid=\"popup\" excludehist=\"false\" showprogress=\"true\">\n',
N'      <button class=\"btn btn-outstanding\">SincronizarMarcajes<\/button>\n',
N'<\/flx-navbutton>",
	"IconName":"noicon",
	"Searcher":false,
	"ShowWhenNew":false,
	...
	"ModuleName":"PERS_DEPURACION_MARCAJES",
	"TypeId":"flx-sqllist",
	"ClassId":"project",
	"Descrip":"PERS_DEPURACION_MARCAJES",
	"Title":"PERS_DEPURACION_MARCAJES",
	"ContainerId":"default",
	"CollapsibleButton":true,
	"FullscreenButton":true,
	"RefreshButton":true,
	"SearchButton":false,
	"SQlSentence":"SELECT Pers_Marcaje.DateTime, PMT.Name AS TimeTypeDescr, Pers_Marcaje.IdTimeType \n',
N'FROM Pers_Marcaje \n',
N'JOIN pers_marcaje_tipo PMT\n',
N'ON Pers_Marcaje.IdTimeType = PMT.IdTipoMarcaje\n',
N'ORDER BY Pers_Marcaje.DateTime DESC",
...
N'  <\/div>\n',
N'",
	"HTMLText":"<div class=\"col-12 col-l-12 col-m-12 col-s-12 nopadding mod-expand\">  \n',
...
concat(convert(nvarchar(max),''),N'                    <\/span>\r\n',
N'                <\/div>\r\n',
N'\r\n',
N'            <\/div>\r\n',
N'        <\/div>\r\n',
...
N'<\/div>",
	...
	"TypeId":"flx-objectlist",
	"ClassId":"project",
	"ObjectName":"Pers_Marcajes",
	"ObjectFilter":"E.EmployeeId = ''{{EmployeeId}}''",
	"Descrip":"PERS_Empleados_Marcajes",
	"Title":"Marcajes",
	"ContainerId":"default",
	"CollapsibleButton":true,
	"FullscreenButton":true,
...
N'<\/div>",
	"IconName":"clock5",
	"PagerId":"syspager-listfooter",
	"PageSize":10,
	"ConnStringID":"DataConnectionString",
	"ToolbarName":"pEmp_Toolbar_Only_Filter",
	...
	"TypeId":"flx-html",
	"ClassId":"project",
	"Descrip":" PERS_HR_Documents_EmployeeSpace",
	"Title":"My Documents",
	"ContainerId":"clean",
	"CollapsibleButton":true,
	"FullscreenButton":true,
...
N'    <div class=\"padding-m\">\r\n',
N'        <div class=\"col-12 emp-flex-Valign\">\r\n',
N'            <div class=\"col-10\">\r\n',
N'                <flx-text class=\"col-12\" placeholder=\"{{translate|Filter}}\" onchange=\"filterEmployeePageDocumentsList(' + convert(nvarchar(max),NCHAR(36)) + N'(this))\" ><\/flx-text>\r\n',
N'            <\/div>\r\n',
N'            <span class=\"col-2 emp-flex-end clickable {{currentRoleId|switch:[admins:,hresources:,PERS_ADMIN_PROGECO:,else:hide]}} {{EmployeeId|isnull:hide}}\">\r\n',
N'                <flx-navbutton type=\"openpage\" pagetypeid=\"list\" objectname=\"Documents_Object\" objectwhere=\"(Documents_Objects.ObjectId = {{EmployeeId}} And Documents_Objects.ObjectName = ''emp_Employee'')\" \r\n',
N'                defaults=\"{''ObjectId'':''{{EmployeeId}}'',''ObjectName'':''emp_Employee''}\" targetid=\"popup800x600\" excludehist=\"false\">\r\n',
N'                    <button class=\"emp-new-btn padding-m emp-flex-align\"><i class=\"flx-icon icon-clip\" title=\"{{translate|Add new documents}}\"><\/i><\/button>\r\n',
N'                <\/flx-navbutton> \r\n',
N'            <\/span>\r\n',
N'        <\/div>\r\n',
N'\r\n',
N'        <div class=\"col-12\">\r\n',
N'            <div class=\"col-12\">\r\n',
N'                <flx-module modulename=\"HR_SysDocumentsCategories_FolderList\" type=\"flx-list\" class=\"empty padding-0\">\r\n',
N'                    <flx-list mode=\"list\" objectname=\"emp_Employee\" objectwhere=\"Documents_Objects.ObjectId=''{{EmployeeId}}'' And Documents_Objects.ObjectName = ''emp_Employee''\" \r\n',
N'                    id=\"mod-HR_SysDocumentsCategories_FolderList\" modulename=\"HR_SysDocumentsCategories_FolderList\"><\/flx-list>\r\n',
N'                <\/flx-module>\r\n',
N'            <\/div>\r\n',
N'            <div class=\"col-12\">\r\n',
N'\r\n',
N'            <div class=\"col-12\">\r\n',
N'                <flx-module modulename=\"HR_OnlyDocuments_EmployeeSpace\" type=\"flx-list\" class=\"empty padding-0\">\r\n',
N'                    <flx-list mode=\"list\" objectname=\"emp_Employee\" objectwhere=\"Documents_Objects.ObjectId=''{{EmployeeId}}'' And Documents_Objects.ObjectName = ''emp_Employee''\" \r\n',
N'                    id=\"mod-HR_OnlyDocuments_EmployeeSpace\" modulename=\"HR_OnlyDocuments_EmployeeSpace\"><\/flx-list>\r\n',
N'                <\/flx-module>\r\n',
N'            <\/div>\r\n',
N'            <\/div>\r\n',
N'        <\/div>\r\n',
...
N'<\/div>",
	...
	"PagerId":"syspager-listboth",
	"PageSize":20,
	"ConnStringID":"ConfConnectionString",
	"Searcher":false,
	"ShowWhenNew":false,
	"ManualInit":false,
	"Reserved":false,
	...
	"flxInsertedBy":"admin",
	"flxUpdatedBy":"admin",
	"flxInsertedDate":"2026-06-01T10:52:00",
	"flxUpdatedDate":"2026-06-01T10:52:00",
	"OriginAddonId":"Main",
	"OriginId":2
},{
	...
	"TypeId":"flx-objectlist",
	"ClassId":"system",
	"ObjectName":"emp_News_Categories",
	"ObjectFilter":"(na.InsertedBy=''0'' AND na.StatusId=0) or (na.StatusId=1 AND na.PubDate <= GETDATE())",
	"Descrip":"PERS_News_Categories_List_Module",
	"Title":"{{ObjectDescrip}}",
	"ContainerId":"noheader",
	"CollapsibleButton":true,
	"FullscreenButton":true,
	"RefreshButton":true,
	"SearchButton":true,
	"IconName":"sysobjecticon",
	"PageSize":1000,
	"ToolbarName":"News_Categories_Toolbar",
	"GridbarName":"systb-row",
	"TemplateId":"PERS_News_Category",
	"ModuleClass":"emp-module-transparent",
	"Searcher":false,
	"ShowWhenNew":false,
	"ManualInit":false,
	"Reserved":false,
	...
	"ModuleViewers":false,
	"Active":true,
	"SkeletonId":"EMP_EmptySkeleton",
	"flxInsertedBy":"admin",
	"flxUpdatedBy":"admin",
	"flxInsertedDate":"2025-03-05T15:25:00",
	"flxUpdatedDate":"2025-03-05T15:39:00",
	"OriginAddonId":"Main",
	"OriginId":2
},{
	...
	"ObjectFilter":"{{ObjectWhere}}",
	"Descrip":"Pers_Notificacion_View_Module",
	"Title":"{{ObjectDescrip}}",
	"ContainerId":"noheader",
	"CollapsibleButton":true,
	"FullscreenButton":true,
	...
	"IconName":"sysobjecticon",
	"PageSize":100,
	"ToolbarName":"News_Article_Toolbar",
	"ModuleClass":"padding-l",
	"Searcher":false,
	"ShowWhenNew":false,
	"ManualInit":false,
	"Reserved":false,
	...
	"flxInsertedBy":"admin",
	"flxUpdatedBy":"admin",
	"flxInsertedDate":"2025-03-04T21:41:00",
	"flxUpdatedDate":"2025-03-04T21:41:00",
	"OriginAddonId":"Main",
	"OriginId":2
},{
	...
	"ObjectFilter":"PERS_Notificaciones.EmployeeId= {{EmployeeId}}",
	"Descrip":"PERS_Notificaciones_Empleado",
	...
	"PagerId":"syspager-listfooter",
	"PageSize":5,
	"ToolbarName":"emp_ListToolbar_Custom",
	...
	"ClassId":"project",
	"ObjectName":"PERS_Notificaciones",
	"ObjectFilter":"PERS_Notificaciones_Reads.IdNotificacion={{IdNotificacion}}",
	"Descrip":"PERS_Notificaciones_Reads_Module",
	"Title":"PERS_Notificaciones_Reads_Module",
	"ContainerId":"noheader",
	"CollapsibleButton":true,
	"FullscreenButton":true,
	"RefreshButton":true,
	...
	"flxUpdatedDate":"2025-03-05T08:54:00",
	"OriginAddonId":"Main",
	"OriginId":2
},{
	...
	"ClassId":"project",
	"ObjectName":"PERS_Notificaciones",
	"ObjectFilter":"IdNotificacion={{IdNotificacion}}",
	"Descrip":"PERS_Notiificaciones_Likeas_Module",
	"Title":"News_Article_Likes_Module",
	"ContainerId":"noheader",
	"CollapsibleButton":true,
	"FullscreenButton":true,
	"RefreshButton":true,
